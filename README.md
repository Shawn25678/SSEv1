...
A local Path of Exile 2 boss tracker. Log kills and drops, watch completion and drop rates, and check prices. Nothing hooks the game client — you run it beside PoE 2 and record what dropped.

## What it does

- **Dashboard** — pick a boss, tap kill, and log loot as you farm
